...
F_alphaddotcoeff_2=@(alpha__hat,epsilon,s__1,s__2) -(-s__2 + r__a)*r__a*sin(epsilon)*M__a*cos(alpha__hat) - M__a*(-r__a*sin(alpha__hat)*s__1 - r__a^2 + 2*s__2*r__a - s__1^2 - s__2^2)*sin(epsilon) + I__yz;
...
F_thetaddotcoeff_2=@(alpha__hat,epsilon,s__1,s__2) 2*(-1/2*r__a^2 + s__2*r__a + 1/2*s__1^2 - 1/2*s__2^2)*cos(epsilon)^2*M__a*cos(alpha__hat)^2 + (((2*r__a*s__1 - 2*s__1*s__2)*sin(alpha__hat) - 2*r__a*(-r__a + s__2))*cos(epsilon)^2 + 2*r__a*(-r__a + s__2))*M__a*cos(alpha__hat) - 2*(r__a*sin(alpha__hat)*s__1 + r__a^2/2 + s__1^2/2)*M__a*cos(epsilon)^2 + 2*M__a*r__a*s__1*sin(alpha__hat) + 2*(r__a^2 - s__2*r__a + 1/2*s__1^2 + 1/2*s__2^2)*M__a + I__zz;
...
F_epsddotcoeff_2=@(alpha__hat,epsilon,s__1,s__2) 2*(-r__a*s__1 + s__1*s__2)*cos(epsilon)*M__a*cos(alpha__hat)^2 + ((-r__a^2 + 2*r__a*s__2 + s__1^2 - s__2^2)*sin(alpha__hat) + r__a*s__1)*cos(epsilon)*M__a*cos(alpha__hat) + 2*M__a*(r__a*sin(alpha__hat)/2 + s__1/2)*(-s__2 + r__a)*cos(epsilon) + I__xz;
...
F_thetaddotcoeff_final_2=@(alpha__hat,theta,epsilon,s__1,s__2) F_thetaddotcoeff_2(alpha__hat,epsilon,s__1,s__2); %mistake x=vcos(theta): +F_thetaddotextra_x_2(alpha__hat,theta,epsilon,s__1,s__2)+F_thetaddotextra_y_2(alpha__hat,theta,epsilon,s__1,s__2);
...
F_equationextra_2=@(alpha__hat,theta,epsilon,s__1,s__2) -v*sin(theta)*theta__dot*F_xddotcoeff_2(alpha__hat,theta,epsilon,s__1,s__2) +v*cos(theta)*theta__dot*F_yddotcoeff_2(alpha__hat,theta,epsilon,s__1,s__2);%mistake x=vcos(theta): -v*cos(theta)*(theta__dot)^2*F_xddotcoeff_2(alpha__hat,theta,epsilon,s__1,s__2) -v*sin(theta)*(theta__dot)^2*F_yddotcoeff_2(alpha__hat,theta,epsilon,s__1,s__2);
