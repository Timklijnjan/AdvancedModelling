...
F_thetaddotcoeff_3=@(alpha__hat,epsilon,s__1,s__2) -(2*r__a*s__1 - 2*s__1*s__2)*cos(epsilon)*M__a*cos(alpha__hat)^2 + ((-r__a^2 + 2*r__a*s__2 + s__1^2 - s__2^2)*sin(alpha__hat) + r__a*s__1)*cos(epsilon)*M__a*cos(alpha__hat) - M__a*((-r__a^2 + r__a*s__2)*sin(alpha__hat) - r__a*s__1 + s__1*s__2)*cos(epsilon) + 2*I__xz;
thetaddotcoeff_3=F_thetaddotcoeff_3(alpha__hat,epsilon,s__1,s__2);

F_epsddotcoeff_3=@(alpha__hat,s__1,s__2) -(-r__a^2 + 2*r__a*s__2 + s__1^2 - s__2^2)*M__a*cos(alpha__hat)^2 + ((-2*r__a*s__1 + 2*s__1*s__2)*sin(alpha__hat) + 2*r__a*(s__2 - r__a))*M__a*cos(alpha__hat) + 2*r__a*s__1*M__a*sin(alpha__hat) + (r__a^2 + s__1^2)*M__a + 2*I__xx;
...
F_thetaddotcoeff_final_3=@(alpha__hat,theta,epsilon,s__1,s__2) F_thetaddotcoeff_3(alpha__hat,epsilon,s__1,s__2)+F_thetaddotextra_x_3(alpha__hat,theta,epsilon,s__1,s__2)+F_thetaddotextra_y_3(alpha__hat,theta,epsilon,s__1,s__2);
...
F_equationextra_3=@(alpha__hat,theta,epsilon,s__1,s__2) -v*cos(theta)*(theta__dot)^2*F_xddotcoeff_3(alpha__hat,theta,epsilon,s__1,s__2) -v*sin(theta)*(theta__dot)^2*F_yddotcoeff_3(alpha__hat,theta,epsilon,s__1,s__2);
